...
class Resultado_Personeria : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var conta0a1 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con0a1", 0)
        ...
        var conta0b1 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con0b1", 0)
        ...
        var contakinder1 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("conkinder1", 0)
        var conta6c1 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con6c1", 0)

        var totalVotos1 = 0

// List of all vote counts (including new variables)
        val allVoteCounts1 = listOf(
            conta6c1,contakinder1,conta1a1, conta0a1,conta0b1, conta2a1, conta3a1, conta4a1, conta5a1, conta6a1, conta7a1, conta8a1, conta9a1, conta10a1, conta11a1,
...
// Calculate total votes
        ...
        var conta0a2 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con0a2", 0)
        ...
        var conta0b2 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con0b2", 0)
        ...
        var contakinder2 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("conkinder2", 0)
        var conta6c2 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con6c2", 0)

        var totalVotos2 = 0

// Lista de todas las variables de conteo de votos
        val allVoteCounts2: List<Int> = listOf(
            conta6c2,contakinder2,conta0a2,conta0b2,conta1a2, conta2a2, conta3a2, conta4a2, conta5a2, conta6a2, conta7a2, conta8a2, conta9a2, conta10a2, conta11a2,
...
// Imprime los votos totales (opcional)
        ...
        var conta0a3 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con0a3", 0)
        ...
        var conta0b3 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con0b3", 0)
        ...
        var contakinder3 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("conkinder3", 0)
        var conta6c3 = getSharedPreferences("contador", Context.MODE_PRIVATE).getInt("con6c3", 0)

var totalVotos3 = 0

// List of all vote counts (including new variables)
        val allVoteCounts3 = listOf(
            conta6c3,contakinder3,conta0a3,conta0b3,conta1a3,conta2a3,conta3a3,conta4a3,conta5a3,conta6a3,conta7a3,conta8a3,conta9a3,conta10a3,conta11a3,
...
// Print the total votes (optional)
        ...
        findViewById<TextView>(R.id.v0a1).text = conta0a1.toString()
        ...
        findViewById<TextView>(R.id.v0b1).text = conta0b1.toString()
        ...
        findViewById<TextView>(R.id.kin1).text = contakinder1.toString()
        findViewById<TextView>(R.id.v6c1).text = conta6c1.toString()


        findViewById<TextView>(R.id.v0a2).text = conta0a2.toString()
        ...
        findViewById<TextView>(R.id.v0b2).text = conta0b2.toString()
        ...
        findViewById<TextView>(R.id.kin2).text = contakinder2.toString()
        findViewById<TextView>(R.id.v6c2).text = conta6c2.toString()

        findViewById<TextView>(R.id.v0a3).text = conta0a3.toString()
        ...
        findViewById<TextView>(R.id.v0b3).text = conta0b3.toString()
        ...
        findViewById<TextView>(R.id.kin3).text = contakinder3.toString()
        findViewById<TextView>(R.id.v6c3).text = conta6c3.toString()
